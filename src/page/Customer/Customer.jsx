  ...
  return (
    ...
    <section className=" bg-green-500 h-80 py-6 px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white p-7">
        ...
        <div className="bg-black/60 absolute inset-0 top-80 h-262.5">
            {/* Description Text */}
            <div className="absolute  left-1/2 transform -translate-x-1/2 z-10 top-100">
                <p className="text-white mt-2 text-lg">Please wait ...</p>
                <p className="text-white mt-2 text-lg">Our service provider is going to</p>
                <p className="text-white mt-2 text-lg">accept your booking</p>
            </div>
        </div>
